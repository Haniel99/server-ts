...
import { get_professors_controller,get_horario_profesor } from "../controller/admin/professor_controller";
import {
  get_subjects_controller,
  add_room_controller,
  add_subject_controller,
} from "../controller/admin/department_controller";
import {
...
router.post("/get-horario-profesor", authentication, get_horario_profesor);
export { router };

/**
 * 
 * HOST= "mi3-ts12.a2hosting.com"
USER= "zewocl_gestionhorario"
PASSWORD = "gestionhorario"
DB = "zewocl_gestionhorario" 
JWT_KEY = "12345"
